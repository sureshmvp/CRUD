...
ALTER TABLE purchaseorder ADD COLUMN po_lineDetails INTEGER  REFERENCES "linedetail"(_id);

-- relation 1:m po_webOrderLevel PurchaseOrder - WebOrderLevel
ALTER TABLE purchaseorder ADD COLUMN po_webOrderLevel INTEGER  REFERENCES "weborderlevel"(_id);
